        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <form action="<?php echo base_url()?>admin/notesModify/addNote" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Notes Title:</label>
                    <input type="text" class="form-control" name="notes_title" required value="" placeholder="Enter the title of note">
                  </div>
			
				
				<div class="form-group">
				    <label for="exampleInputEmail1">Select Teacher</label>
                  <select class="form-control" required name="t_id" style="width: 100%;">
